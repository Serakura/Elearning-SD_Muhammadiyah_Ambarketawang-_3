        ...
        <div class="col-xl-12 col-lg-12 col-md-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body text-dark">
                    <?php
                    $query = mysqli_query($koneksi, "SELECT * FROM pilihan_ganda WHERE id_pilgan = $soal");
                    while ($h = mysqli_fetch_row($query)) {
                    ?>
                        <form action="./content/guru/function/updatepilgan.php" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12">
                                        ...
                                        <div class="card-body text-dark">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <input type="text" class="form-control" id="id_pilgan" name="id_pilgan" value="<?= $soal ?>" hidden>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card shadow mb-2">
                                        ...
                                        <div class="card-body text-dark">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea class="form-control ckeditor" name="jawaban_a" id="editor2" required><?php echo $h['2'] ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card shadow mb-2">
                                        ...
                                        <div class="card-body text-dark">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea class="form-control ckeditor" name="jawaban_b" id="editor2" required><?php echo $h['3'] ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card shadow mb-2">
                                        ...
                                        <div class="card-body text-dark">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea class="form-control ckeditor" name="jawaban_c" id="editor2" required><?php echo $h['4'] ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card shadow mb-2">
                                        ...
                                        <div class="card-body text-dark">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea class="form-control ckeditor" name="jawaban_d" id="editor2" required><?php echo $h['5'] ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <select id="kuncijawaban" class="form-control" name="kuncijawaban" required>
                                                        ...
                                                        <option value="A" <?php if ($h[6] == "A") {
                                                                                echo 'selected';
                                                                            } ?>>A</option>
                                                        <option value="B" <?php if ($h[6] == "B") {
                                                                                echo 'selected';
                                                                            } ?>>B</option>
                                                        <option value="C" <?php if ($h[6] == "C") {
                                                                                echo 'selected';
                                                                            } ?>>C</option>
                                                        <option value="D" <?php if ($h[6] == "D") {
                                                                                echo 'selected';
                                                                            } ?>>D</option>
                                                    </select>
                                                </div>
