                ...
                <div class="card-body">
                    <form action="./content/all/function/updatedatadiri.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="" name="" value="<?php if ($role == "guru") {
                                                                                                echo $row['nip'];
                                                                                            } else {
                                                                                                echo $row['nis'];
                                                                                            } ?>" disabled>
                            <input type="hidden" class="form-control" id="" name="<?php if ($role == "guru") {
                                                                                        echo "nip";
                                                                                    } else {
                                                                                        echo "nis";
                                                                                    } ?>" value="<?php if ($role == "guru") {
                                                                                                        echo $row['nip'];
                                                                                                    } else {
                                                                                                        echo $row['nis'];
                                                                                                    } ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="password" name="password" value="<?php echo md5($row['password']); ?>" disabled>
                        </div>
                        <div class="form-group">
